...
**Its only version field is a *software* version — `version: "0.12.13"`, tracking
...
sole version field is `version: "0.12.13"`, the tool version, pinned to `pyproject.toml` and
