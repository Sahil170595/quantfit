...
**Its only version field is a *software* version — `version: "0.12.5"`, tracking
...
sole version field is `version: "0.12.5"`, the tool version, pinned to `pyproject.toml` and
