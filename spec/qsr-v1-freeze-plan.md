...
**Its only version field is a *software* version — `version: "0.11.0"`, tracking
...
sole version field is `version: "0.11.0"`, the tool version, pinned to `pyproject.toml` and
