...
**Its only version field is a *software* version — `version: "0.12.16"`, tracking
...
numbered 5.8.** `spec/qsr-v0.md:447` is *"5.8 The gate adds exit 5"* and what was a second
...
sole version field is `version: "0.12.16"`, the tool version, pinned to `pyproject.toml` and
